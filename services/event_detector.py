    ...
    def _load_event_definitions(self) -> Dict:
        ...
        return {
            "3월_종료": {
                ...
                "trigger_message": "민석이와 충분히 대화를 나눴습니다. 이제 본격적인 4월 훈련을 시작할까요?",
                "hints": [
                    "민석이의 야구 실력에 대해 물어보세요",
                    "앞으로의 목표에 대해 이야기해보세요",
                    "간단한 격려의 말을 건네보세요"
                ]
            },
            "5월_갈등": {
                ...
                "conditions": [
                    ...
                    "민석이가 코치를 어느 정도 신뢰하기 시작했다"
                ],
                "trigger_message": "오늘 민석이가 훈련에 나타나지 않았습니다. 전화도 받지 않고 있습니다.",
                "hints": [
                    "민석이의 과거에 대해 물어보세요",
                    "민석이의 가족 이야기를 들어보세요",
                    "훈련 중 민석이의 태도 변화를 관찰해보세요"
                ]
            }
        }
